...
#继承自Mesa的Agent，表示模拟中的个体
class SocialAgent(Agent):
    def __init__(self, model, name, gender, age, traits, qualification, initial_belief, topic,
                 ...
                 system_prompt="You are a helpful assistant", **kwargs):
